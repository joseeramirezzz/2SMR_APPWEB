const frasesFrikisInformatica = [ "Los programadores no tienen errores, solo experiencias inesperadas.", 
    ...
    // Array con diferentes frases posibles



const btn = document.querySelector(".general__main__section1__boton") // Selección del botón

const body = document.querySelector(".general__main__section1__frase") // Seleccionamos el body para posteriormente cambiarle la frase
...
btn.addEventListener("click", function(){  // Agregamos un "eventlistener" para escuchar el click del botón, cuando haces click se ejecuta la función
    ...
    const FraseAleatorio = frasesFrikisInformatica[Math.floor(Math.random() * frasesFrikisInformatica.length)]; // Seleccionamos una frase aleatoria del array
                                                                        
    body.textContent = FraseAleatorio;  // Cambia el contenido a una frase Aleatoria elegida con la función de arriba

    btn.textContent = "Ver mas contenido"; // Cambia el contenido de texto y pone el nombre del color Aleatorio
